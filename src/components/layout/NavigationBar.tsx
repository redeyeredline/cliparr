...
import { Home, Download, Settings, Zap, Cpu, Monitor, Play, Eye, Shield } from 'lucide-react';
...
const NavigationBar: React.FC<NavigationBarProps> = ({ children }) => {
  ...
  const navItems = [
    ...
    { path: '/admin', label: 'Admin', icon: Shield, shortcut: 'a' },
  ];
      ...
      >
        ...
        <div className="mb-8">
          <button
            ...
            className="flex items-center space-x-3 rounded-lg p-1"
