...
export default function AudioAnalyzer({ audioAnalyses, mediaFiles, onRefresh }: AudioAnalyzerProps) {
    ...
    <Card className="border-0 rounded-2xl shadow-lg bg-slate-800/90 backdrop-blur-md">
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <Button variant="ghost" size="icon" onClick={onRefresh} className="text-slate-200 hover:bg-slate-700">
                ...
                >
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>Avg Volume: {analysis.volume_analysis?.average_volume?.toFixed(2) || 'N/A'} dB</span>
                    </div>
                    <div className="flex items-center gap-2">
